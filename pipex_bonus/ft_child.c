...
/*   Updated: 2024/05/10 04:27:03 by rrimonte         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	child_aux(t_data *g_data, t_env	*envp)
{
	...
	{
		exec_builtin(g_data->cmd_lst->cmd, envp, &g_data->exit_status);
